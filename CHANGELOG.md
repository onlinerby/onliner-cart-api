...
* Добавлено поле `is_third_party` - признак доставки заказа третьему лицу - в [блок с информацией о заказе](docs/order/show.md#описание-полей-ответа)

## 10.09.2026

* Добавлена юридическая информация (`payment.legal_info`) для заказов с безналичными платежами (для юрлиц) в [блок с информацией о заказе](docs/order/show.md#описание-полей-ответа) 

## 10.02.2025

* Добавлена информация (`overpayment` и `overall`) о переплате и стоимости заказа с учётом процентов по кредиту в [блок с информацией о заказе](docs/order/show.md#описание-полей-ответа)
...
* Добавлена информация (`affects_rating`) влияние заказа на рейтинг успешности в [блок с информацией о заказе](docs/order/index.md#описание-полей-ответа)
