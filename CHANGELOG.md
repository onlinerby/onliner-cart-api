...
* Добавлена юридическая информация для заказов с безналичными платежами (для юрлиц) в [блок с информацией о заказе](docs/order/show.md#описание-полей-ответа) 
