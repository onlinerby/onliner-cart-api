...
### Пример запроса со способом оплаты для юрлиц
...
```json
{
    ...
    "payment": {
        ...
        "legal_info": {
            "unp": "123456789",
            "name": "ООО Онлайнер",
            "address": "г. Минск, ул. Тимирязева, 67",
            "bank": {
            ...
            "edi": {
                ...
                "delivery_gln": "3210987654321",
                "operator": "ЭДиН (OOO «Электронные документы и накладные»)"
            },
            "signer": {
                "position": "Директор",
...
| payment.legal_info                               | object/null       | Реквизиты юридического лица. Заполнены только для заказов с оплатой `cashless` (Недоступно, если заказ находится в некоторых статусах)                       |
| payment.legal_info.unp                           | string            | УНП организации                                                                                                                                              |
| payment.legal_info.name                          | string            | Название организации                                                                                                                                         |
| payment.legal_info.address                       | string            | Юридический адрес организации                                                                                                                                |
| payment.legal_info.bank                          | object            | Банковские реквизиты организации                                                                                                                             |
| payment.legal_info.bank.iban                     | string            | IBAN                                                                                                                                                         |
| payment.legal_info.bank.name                     | string            | Название банка                                                                                                                                               |
| payment.legal_info.bank.bic                      | string            | БИК банка                                                                                                                                                    |
| payment.legal_info.edi                           | object            | Информация для электронного документооборота                                                                                                                 |
| payment.legal_info.edi.org_gln                   | string/null       | GLN офиса                                                                                                                                                    |
| payment.legal_info.edi.delivery_gln              | string/null       | GLN склада                                                                                                                                                   |
| payment.legal_info.edi.operator                  | string/null       | Название EDI-провайдера                                                                                                                                      |
| payment.legal_info.signer                        | object            | Информация о подписанте                                                                                                                                      |
| payment.legal_info.signer.position               | string/null       | Должность подписанта                                                                                                                                         |
| payment.legal_info.signer.full_name              | string/null       | ФИО подписанта                                                                                                                                               |
| payment.legal_info.signer.authority              | object            | Информация об основании полномочий подписанта                                                                                                                |
